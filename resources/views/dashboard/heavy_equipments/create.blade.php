...
@push('title-header', 'Tambah Data Alat Berat')
@push('breadcrumbs')
    <li class="breadcrumb-item"><a href="{{ route('heavy-equipments.index') }}">Data Alat Berat</a></li>
    <li class="breadcrumb-item active">Tambah Data Alat Berat</li>
@endpush
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('heavy-equipments.store') }}" method="POST" role="form" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                                placeholder="Nama Alat Berat" value="{{ old('name') }}" name="name">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" class="form-control @error('rental_price') is-invalid @enderror"
                                                id="rental_price" placeholder="Harga Sewa Alat Berat" value="{{ old('rental_price') }}"
                                                name="rental_price">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" class="form-control @error('operator_price') is-invalid @enderror"
                                                id="operator_price" placeholder="Harga Operator Alat Berat" value="{{ old('operator_price') }}"
                                                name="operator_price">

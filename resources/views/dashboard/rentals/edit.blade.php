@extends('layouts.app')
@section('title', 'Ubah Data Transaksi Penyewaann')

@push('title-header', 'Ubah Data Transaksi Penyewaann')
@push('breadcrumbs')
    <li class="breadcrumb-item"><a href="{{ route('rentals.index') }}">Data Transaksi Penyewaann</a></li>
    <li class="breadcrumb-item active">Ubah Data Transaksi Penyewaann</li>
@endpush
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card shadow">
                        <div class="card-body">
                            <form action="{{ route('rentals.update', $rental->id) }}" method="POST" role="form"
                                            ...
                                            <select class="form-control @error('heavy_equipment_id') is-invalid @enderror"
                                                ...
                                                @foreach ($heavyEquipments as $equipment)
                                                    <option value="{{ $equipment->id }}"
                                                        {{ old('heavy_equipment_id', $rental->heavy_equipment_id) == $equipment->id ? 'selected' : '' }}>
                                                        {{ $equipment->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="form-control @error('rental_date') is-invalid @enderror" id="rental_date"
                                                placeholder="Tanggal Sewa" value="{{ old('rental_date', $rental->rental_date) }}" name="rental_date">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="form-control @error('return_date') is-invalid @enderror" id="return_date"
                                                placeholder="Tanggal Pengembalian" value="{{ old('return_date', $rental->return_date) }}" name="return_date">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                                                ...
                                                @foreach ($roles as $status)
                                                    <option value="{{ $status }}" @if (old('status', $rental->status) == $status) selected @endif>
